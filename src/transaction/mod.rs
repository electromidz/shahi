...
impl Transaction {
    ...
    pub fn new(sender: String, receiver: String, amount: u64, secret_key: &SecretKey) -> Self {
    ...
    fn create_message(sender: &str, receiver: &str, amount: u64) -> Message {
...
mod tests {
    ...
    fn test_transaction_creation_and_verification() {
        ...
        // Create a new transaction
        let amount = 100;
        let transaction = Transaction::new(sender.clone(), receiver.clone(), amount, &secret_key);
        ...
        tampered_transaction.amount = 200; // Change the amount
